...
void halCommonMemCopy(void *dest, const void *source, int16u bytes)
{
  memcpy(dest, source, bytes);
}

int8s halCommonMemCompare(const void *source0, const void *source1, int16u bytes)
{
...
{
  if (INT_MGMTFLAG & INT_MGMTOSC24MLO) {
