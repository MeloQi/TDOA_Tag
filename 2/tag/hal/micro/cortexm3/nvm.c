...
NO_STRIPPING(NO_INIT(VAR_AT_SEGMENT (const int8u nvmStorageLeft[NVM_DATA_SIZE_B], __NVM__)));
NO_STRIPPING(NO_INIT(VAR_AT_SEGMENT (const int8u nvmStorageRight[NVM_DATA_SIZE_B], __NVM__)));

static int8u determineState(void)
{
  int32u *leftMgmtPtr = (int32u *) NVM_LEFT_PAGE;
  int32u leftMgmt = *leftMgmtPtr;
  int32u *rightMgmtPtr = (int32u *)NVM_RIGHT_PAGE;
  int32u rightMgmt = *rightMgmtPtr;
  int8u state=0;
