...
#define DATA_FLASH_BASE_END                                  (0x0003FFFFu)
#endif
...
#endif
#ifdef CORTEXM3_STM32W108CC
#define DATA_FLASH_END                                       (0x0803FFFFu)
#endif
...
#endif
#ifdef CORTEXM3_STM32W108CC
#define DATA_BIG_INFO_BASE_END                               (0x000047FFu)
#endif
...
#endif
#ifdef CORTEXM3_STM32W108CC
#define DATA_SMALL_INFO_END                                  (0x08040FFFu)
#endif
#define DATA_SMALL_INFO_SIZE                                 (DATA_SMALL_INFO_END - DATA_SMALL_INFO_BASE + 1)

#ifdef CORTEXM3_STM32W108CC
/* BIG_INFO_EXTENDED block */
#define DATA_BIG_INFO_EXTENDED_BASE                                   (0x08041000u)
#define DATA_BIG_INFO_EXTENDED_END                                    (0x08044FFFu)
#define DATA_BIG_INFO_EXTENDED_SIZE                                   (DATA_BIG_INFO_END - DATA_BIG_INFO_BASE + 1)
#endif
...
#endif
#ifdef CORTEXM3_STM32W108CC
#define DATA_SRAM_END                                        (0x20003FFFu)
#endif
...
#endif
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* MAC_RAM_OFFS field */
        #define MAC_RX_ST_ADDR_A_MAC_RAM_OFFS                (0xFFFFC000u)
        #define MAC_RX_ST_ADDR_A_MAC_RAM_OFFS_MASK           (0xFFFFC000u)
        #define MAC_RX_ST_ADDR_A_MAC_RAM_OFFS_BIT            (14)
        #define MAC_RX_ST_ADDR_A_MAC_RAM_OFFS_BITS           (18)
        /* MAC_RX_ST_ADDR_A field */
        #define MAC_RX_ST_ADDR_A_MAC_RX_ST_ADDR_A            (0x00003FFEu)
        #define MAC_RX_ST_ADDR_A_MAC_RX_ST_ADDR_A_MASK       (0x00003FFEu)
        #define MAC_RX_ST_ADDR_A_MAC_RX_ST_ADDR_A_BIT        (1)
        #define MAC_RX_ST_ADDR_A_MAC_RX_ST_ADDR_A_BITS       (13)
#endif
...
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* MAC_RAM_OFFS field */
        #define MAC_RX_END_ADDR_A_MAC_RAM_OFFS               (0xFFFFC000u)
        #define MAC_RX_END_ADDR_A_MAC_RAM_OFFS_MASK          (0xFFFFC000u)
        #define MAC_RX_END_ADDR_A_MAC_RAM_OFFS_BIT           (14)
        #define MAC_RX_END_ADDR_A_MAC_RAM_OFFS_BITS          (18)
        /* MAC_RX_END_ADDR_A field */
        #define MAC_RX_END_ADDR_A_MAC_RX_END_ADDR_A          (0x00003FFEu)
        #define MAC_RX_END_ADDR_A_MAC_RX_END_ADDR_A_MASK     (0x00003FFEu)
        #define MAC_RX_END_ADDR_A_MAC_RX_END_ADDR_A_BIT      (1)
        #define MAC_RX_END_ADDR_A_MAC_RX_END_ADDR_A_BITS     (13)
#endif
...
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* MAC_RAM_OFFS field */
        #define MAC_RX_ST_ADDR_B_MAC_RAM_OFFS                (0xFFFFC000u)
        #define MAC_RX_ST_ADDR_B_MAC_RAM_OFFS_MASK           (0xFFFFC000u)
        #define MAC_RX_ST_ADDR_B_MAC_RAM_OFFS_BIT            (14)
        #define MAC_RX_ST_ADDR_B_MAC_RAM_OFFS_BITS           (18)
        /* MAC_RX_ST_ADDR_B field */
        #define MAC_RX_ST_ADDR_B_MAC_RX_ST_ADDR_B            (0x00003FFEu)
        #define MAC_RX_ST_ADDR_B_MAC_RX_ST_ADDR_B_MASK       (0x00003FFEu)
        #define MAC_RX_ST_ADDR_B_MAC_RX_ST_ADDR_B_BIT        (1)
        #define MAC_RX_ST_ADDR_B_MAC_RX_ST_ADDR_B_BITS       (13)
#endif
...
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* MAC_RAM_OFFS field */
        #define MAC_RX_END_ADDR_B_MAC_RAM_OFFS               (0xFFFFC000u)
        #define MAC_RX_END_ADDR_B_MAC_RAM_OFFS_MASK          (0xFFFFC000u)
        #define MAC_RX_END_ADDR_B_MAC_RAM_OFFS_BIT           (14)
        #define MAC_RX_END_ADDR_B_MAC_RAM_OFFS_BITS          (18)
        /* MAC_RX_END_ADDR_B field */
        #define MAC_RX_END_ADDR_B_MAC_RX_END_ADDR_B          (0x00003FFEu)
        #define MAC_RX_END_ADDR_B_MAC_RX_END_ADDR_B_MASK     (0x00003FFEu)
        #define MAC_RX_END_ADDR_B_MAC_RX_END_ADDR_B_BIT      (1)
        #define MAC_RX_END_ADDR_B_MAC_RX_END_ADDR_B_BITS     (13)
#endif
...
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* MAC_RAM_OFFS field */
        #define MAC_TX_ST_ADDR_A_MAC_RAM_OFFS                (0xFFFFC000u)
        #define MAC_TX_ST_ADDR_A_MAC_RAM_OFFS_MASK           (0xFFFFC000u)
        #define MAC_TX_ST_ADDR_A_MAC_RAM_OFFS_BIT            (14)
        #define MAC_TX_ST_ADDR_A_MAC_RAM_OFFS_BITS           (18)
        /* MAC_TX_ST_ADDR_A field */
        #define MAC_TX_ST_ADDR_A_MAC_TX_ST_ADDR_A            (0x00003FFEu)
        #define MAC_TX_ST_ADDR_A_MAC_TX_ST_ADDR_A_MASK       (0x00003FFEu)
        #define MAC_TX_ST_ADDR_A_MAC_TX_ST_ADDR_A_BIT        (1)
        #define MAC_TX_ST_ADDR_A_MAC_TX_ST_ADDR_A_BITS       (13)
#endif
...
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* MAC_RAM_OFFS field */
        #define MAC_TX_END_ADDR_A_MAC_RAM_OFFS               (0xFFFFC000u)
        #define MAC_TX_END_ADDR_A_MAC_RAM_OFFS_MASK          (0xFFFFC000u)
        #define MAC_TX_END_ADDR_A_MAC_RAM_OFFS_BIT           (14)
        #define MAC_TX_END_ADDR_A_MAC_RAM_OFFS_BITS          (18)
        /* MAC_TX_END_ADDR_A field */
        #define MAC_TX_END_ADDR_A_MAC_TX_END_ADDR_A          (0x00003FFEu)
        #define MAC_TX_END_ADDR_A_MAC_TX_END_ADDR_A_MASK     (0x00003FFEu)
        #define MAC_TX_END_ADDR_A_MAC_TX_END_ADDR_A_BIT      (1)
        #define MAC_TX_END_ADDR_A_MAC_TX_END_ADDR_A_BITS     (13)
#endif
...
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* MAC_RAM_OFFS field */
        #define MAC_TX_ST_ADDR_B_MAC_RAM_OFFS                (0xFFFFC000u)
        #define MAC_TX_ST_ADDR_B_MAC_RAM_OFFS_MASK           (0xFFFFC000u)
        #define MAC_TX_ST_ADDR_B_MAC_RAM_OFFS_BIT            (14)
        #define MAC_TX_ST_ADDR_B_MAC_RAM_OFFS_BITS           (18)
        /* MAC_TX_ST_ADDR_B field */
        #define MAC_TX_ST_ADDR_B_MAC_TX_ST_ADDR_B            (0x00003FFEu)
        #define MAC_TX_ST_ADDR_B_MAC_TX_ST_ADDR_B_MASK       (0x00003FFEu)
        #define MAC_TX_ST_ADDR_B_MAC_TX_ST_ADDR_B_BIT        (1)
        #define MAC_TX_ST_ADDR_B_MAC_TX_ST_ADDR_B_BITS       (13)
#endif
...
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* MAC_RAM_OFFS field */
        #define MAC_TX_END_ADDR_B_MAC_RAM_OFFS               (0xFFFFC000u)
        #define MAC_TX_END_ADDR_B_MAC_RAM_OFFS_MASK          (0xFFFFC000u)
        #define MAC_TX_END_ADDR_B_MAC_RAM_OFFS_BIT           (14)
        #define MAC_TX_END_ADDR_B_MAC_RAM_OFFS_BITS          (18)
        /* MAC_TX_END_ADDR_B field */
        #define MAC_TX_END_ADDR_B_MAC_TX_END_ADDR_B          (0x00003FFEu)
        #define MAC_TX_END_ADDR_B_MAC_TX_END_ADDR_B_MASK     (0x00003FFEu)
        #define MAC_TX_END_ADDR_B_MAC_TX_END_ADDR_B_BIT      (1)
        #define MAC_TX_END_ADDR_B_MAC_TX_END_ADDR_B_BITS     (13)
#endif
...
#endif
#ifdef CORTEXM3_STM32W108CC
#define SILICON_ID_RESET                                     (0x069B0041u)
#endif
        /* HW_VERSION field */
...
#if (DATA_SRAM_SIZE == (16 * 1024))
        /* DMA_PROT_OFFS field */
        #define DMA_PROT_ADDR_DMA_PROT_OFFS                  (0xFFFFC000u)
        #define DMA_PROT_ADDR_DMA_PROT_OFFS_MASK             (0xFFFFC000u)
        #define DMA_PROT_ADDR_DMA_PROT_OFFS_BIT              (14)
        #define DMA_PROT_ADDR_DMA_PROT_OFFS_BITS             (18)
        /* DMA_PROT_ADDR field */
        #define DMA_PROT_ADDR_DMA_PROT_ADDR                  (0x00003FFFu)
        #define DMA_PROT_ADDR_DMA_PROT_ADDR_MASK             (0x00003FFFu)
        #define DMA_PROT_ADDR_DMA_PROT_ADDR_BIT              (0)
        #define DMA_PROT_ADDR_DMA_PROT_ADDR_BITS             (14)
#endif
