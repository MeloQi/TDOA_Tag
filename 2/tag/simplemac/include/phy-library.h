/**
 * @file simplemac/include/phy-library.h
...
/** @addtogroup SimpleMACAPI SimpleMAC API
 * SimpleMAC API \see phy-library.h for documentation.
 *
 *@{
 */
 ...
 */
#define SIMPLEMAC_VERSION_MINOR 1
...
typedef int8u RadioPowerMode;
#else
typedef enum RadioPowerModeEnum {
  /**
   * @brief Maximum valid radio transmit power in dBm
   */
  ST_RADIO_POWER_MODE_RX_ON,
...
#ifndef ST_TYPES_H
/**
 * @name txPowerModes for ST_RadioSetPowerMode
 */
//@{
...
//---------------------------------------------------------------------------
/** @name Radio power state control APIs
 *
 * @brief
 ...
 * @return ::ST_SUCCESS or a status code indicating the reason for failure.
 */
StStatus ST_RadioSetChannel(int8u channel);
 ...
 * @return ::ST_SUCCESS or a status code indicating the reason for failure.
 */
StStatus ST_RadioSetChannelAndForceCalibration(int8u channel);
 ...
 */
StStatus ST_RadioTransmit(int8u* packet);
 ...
 * considered clear.
 */
void ST_RadioSetEdCcaThreshold(int8s threshold);
 ...
 * dBm.
 */
int8s ST_RadioGetEdCcaThreshold(void);
 ...
 * overriden if users define their own callback.
 */
extern void ST_RadioSfdSentIsrCallback(int32u sfdSentTime);
 ...
 */
StStatus ST_RadioSetPower(int8s power);
 ...
 * overriden if users define their own callback.
 */
extern void ST_RadioReceiveIsrCallback(int8u *packet,
 ...
 *
 */
void ST_RadioSetNodeId(int16u nodeId);
 ...
 */
void ST_RadioSetPanId(int16u panId);
 ...
 * overriden if users define their own callback.
 */
extern boolean ST_RadioDataPendingLongIdIsrCallback(int8u* longId);
 ...
 * overriden if users define their own callback.
 */
extern boolean ST_RadioDataPendingShortIdIsrCallback(int16u shortId);
 ...
 */
int32u ST_RadioGetMacTimer(void);
 ...
 */
void ST_RadioSetMacTimerCompare(int32u value);
 ...
 */
int32u ST_RadioGetMacTimerCompare(void);
 ...
 */
void ST_AesEncrypt(int8u* block);
 ...
 */
int8s ST_RadioEnergyDetection(void);
 ...
 */
void ST_RadioGetRandomNumbers(int16u *rn, int8u count);
 ...
 */
StStatus ST_RadioSetPowerMode(int16u txPowerMode);
 ...
 */
int16u ST_RadioGetPowerMode(void);
